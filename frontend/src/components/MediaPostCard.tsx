    ...
    >
      <div className={`relative overflow-hidden bg-black ${aspectClassName}`}>
        ...
        {post.mediaType === 'VIDEO' ? (
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_35%,rgba(245,158,11,0.18),transparent_34%),linear-gradient(135deg,rgba(245,158,11,0.08),transparent_38%,rgba(255,255,255,0.04))]" />
        ) : null}
        ...
        {post.mediaType === 'VIDEO' ? (
          <div className="pointer-events-none absolute inset-x-4 bottom-4 flex flex-col gap-3">
            <div className="inline-flex w-fit items-center gap-2 rounded-full border border-white/10 bg-black/70 px-3 py-2 text-xs font-semibold text-white backdrop-blur">
            ...
            <div className="max-w-[18rem]">
              <p className="text-xs font-black uppercase tracking-wide text-amber-300">Video Highlight</p>
              <p className="mt-1 text-sm font-semibold leading-snug text-white">
                Open to play this training clip.
              </p>
            </div>
          </div>
        ) : null}
