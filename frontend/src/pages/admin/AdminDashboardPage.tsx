...
export default function AdminDashboardPage() {
  ...
  return (
    <div>
      ...
      <h2 className="text-gray-400 text-sm font-semibold uppercase tracking-widest mb-4">Bookings & Content</h2>
      ...
      <h2 className="text-gray-400 text-sm font-semibold uppercase tracking-widest mb-4">People & Roles</h2>
