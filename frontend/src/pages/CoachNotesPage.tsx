  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6 gap-4 flex-wrap">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1">
            Record player feedback and coaching observations after sessions.
          </p>
        </div>
        {!showForm && (
          <button
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-center gap-3 mt-4 md:mt-0 self-end pb-0.5">
              ...
              />
              <label htmlFor="cn-visible" className="text-sm text-gray-300 cursor-pointer">
      ...
      {notes.length > 0 && (
        <div className="mb-4">
          <input
            ...
            placeholder="Filter by player email, name, or title…"
      ...
      {visibleNotes.length === 0 ? (
        <EmptyState
          icon="FileText"
          title={filterQuery ? 'No notes match that filter' : 'No progress notes yet'}
          description={
            filterQuery
              ? 'Try a different player email, name, or title.'
              : 'Write your first note after a session to give players personalised feedback.'
          }
        />
      ) : (
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 flex-wrap mb-1">
                    {n.title && <h3 className="text-white font-bold">{n.title}</h3>}
                    {n.noteType && (
