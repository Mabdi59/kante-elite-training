    ...
    <div className="space-y-6">
      ...
      {filteredBookings.length === 0 ? (
        <EmptyState
          ...
          action={
            <Link to="/book" className="bg-teal-500 text-black font-bold px-5 py-2 rounded-lg text-sm">
              Book a Session
            </Link>
          }
        />
              ...
              <div key={booking.id} className="bg-gray-900 border border-gray-800 rounded-xl p-5">
                <div className="flex items-start justify-between gap-4 flex-wrap">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Link
                      to="/book"
                      className="text-sm text-teal-400 border border-teal-400/30 hover:bg-teal-400/10 rounded-lg px-4 py-2"
                    >
                      Book Again
                    </Link>
                  </div>
