...
const navItems = [
  { path: '/captain', label: 'Dashboard', icon: 'D' },
  { path: '/captain/tournaments', label: 'Tournaments', icon: 'T' },
  { path: '/captain/registrations', label: 'Registrations', icon: 'R' },
]
    ...
    <div className="min-h-screen bg-gray-950 flex">
      <aside className="w-64 bg-gray-900 border-r border-gray-800 flex flex-col">
        <div className="p-6 border-b border-gray-800">
          ...
          <p className="text-orange-400 text-xs mt-1 font-semibold uppercase tracking-widest">
            Captain Portal
          </p>
        </div>
        ...
        <div className="p-4 border-t border-gray-800">
          <div className="text-sm text-gray-400 mb-3">
            ...
            <br />
            <span className="text-orange-400 text-xs">{user?.email}</span>
          </div>
          <button
